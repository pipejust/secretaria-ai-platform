...
DEFAULT_CONTENT: Dict[str, Any] = {
    ...
    "product_page": {
        "eyebrow": {"es": "Producto", "ca": "Producte", "en": "Product"},
        "title": {
            "es": "Todo lo que necesitas para transformar reuniones en resultados accionables.",
            "ca": "Tot el que necessites per transformar reunions en resultats accionables.",
            "en": "Everything you need to turn meetings into actionable results.",
        },
        "subtitle": {
            "es": "Acten conecta cada etapa de la conversación con su impacto: captura, interpreta, organiza y da seguimiento. Sin trabajo manual.",
            "ca": "Acten connecta cada etapa de la conversa amb el seu impacte: captura, interpreta, organitza i fa seguiment. Sense feina manual.",
            "en": "Acten connects every stage of the conversation with its impact: capture, interpret, organize and follow up. No manual work.",
        },
        "blocks": [
            {
                "title": {"es": "Captura e inteligencia", "ca": "Captura i intel·ligència", "en": "Capture and intelligence"},
                "items": [
                    {"es": "Transcripción multilenguaje", "ca": "Transcripció multilingüe", "en": "Multilingual transcription"},
                    {"es": "Identificación de hablantes, temas y contexto", "ca": "Identificació de parlants, temes i context", "en": "Speaker, topic and context identification"},
                    {"es": "Detección de momentos clave", "ca": "Detecció de moments clau", "en": "Key moments detection"},
                    {"es": "Reconocimiento de intenciones", "ca": "Reconeixement d'intencions", "en": "Intent recognition"},
                ],
            },
            {
                "title": {"es": "Estructura y organización", "ca": "Estructura i organització", "en": "Structure and organization"},
                "items": [
                    {"es": "Resúmenes ejecutivos", "ca": "Resums executius", "en": "Executive summaries"},
                    {"es": "Decisiones y riesgos", "ca": "Decisions i riscos", "en": "Decisions and risks"},
                    {"es": "Tareas con responsables", "ca": "Tasques amb responsables", "en": "Tasks with owners"},
                    {"es": "Línea de tiempo", "ca": "Línia de temps", "en": "Timeline"},
                ],
            },
            {
                "title": {"es": "Documentos y comunicación", "ca": "Documents i comunicació", "en": "Documents and communication"},
                "items": [
                    {"es": "Actas profesionales", "ca": "Actes professionals", "en": "Professional minutes"},
                    {"es": "Reportes personalizados", "ca": "Informes personalitzats", "en": "Custom reports"},
                    {"es": "Plantillas reutilizables", "ca": "Plantilles reutilitzables", "en": "Reusable templates"},
                    {"es": "Envío automático por correo", "ca": "Enviament automàtic per correu", "en": "Automatic email delivery"},
                ],
            },
            {
                "title": {"es": "Seguimiento y control", "ca": "Seguiment i control", "en": "Tracking and control"},
                "items": [
                    {"es": "Estado de tareas", "ca": "Estat de tasques", "en": "Task status"},
                    {"es": "Recordatorios automáticos", "ca": "Recordatoris automàtics", "en": "Automatic reminders"},
                    {"es": "Historial completo", "ca": "Historial complet", "en": "Full history"},
                    {"es": "Métricas y analítica", "ca": "Mètriques i analítica", "en": "Metrics and analytics"},
                ],
            },
        ],
        "cta_title": {
            "es": "Conoce Acten en acción",
            "ca": "Coneix Acten en acció",
            "en": "See Acten in action",
        },
        "cta_subtitle": {
            "es": "Pídenos una demo y vemos cómo aplica a tu equipo.",
            "ca": "Demana'ns una demo i veiem com aplica al teu equip.",
            "en": "Request a demo and we'll see how it applies to your team.",
        },
        "cta_label": {"es": "Solicitar demo", "ca": "Demana demo", "en": "Request a demo"},
        "cta_url": "/demo",
    },
    ...
    # ─── /soluciones ─────────────────────────────────────────────────────
    "solutions_page": {
        "eyebrow": {"es": "Soluciones", "ca": "Solucions", "en": "Solutions"},
        "title": {
            "es": "Acten se adapta a cada equipo, industria y necesidad.",
            "ca": "Acten s'adapta a cada equip, indústria i necessitat.",
            "en": "Acten adapts to every team, industry and need.",
        },
        "subtitle": {"es": "", "ca": "", "en": ""},
        "audiences": [
            {
                "key": "equipos",
                "title": {"es": "Equipos de trabajo", "ca": "Equips de treball", "en": "Work teams"},
                "description": {
                    "es": "Reuniones internas que terminan en decisiones y compromisos claros.",
                    "ca": "Reunions internes que acaben en decisions i compromisos clars.",
                    "en": "Internal meetings that end with clear decisions and commitments.",
                },
                "icon": "users",
            },
            {
                "key": "empresas",
                "title": {"es": "Empresas", "ca": "Empreses", "en": "Companies"},
                "description": {
                    "es": "Visibilidad cross-equipo, trazabilidad para liderazgo, governance.",
                    "ca": "Visibilitat cross-equip, traçabilitat per al lideratge, governança.",
                    "en": "Cross-team visibility, leadership traceability, governance.",
                },
                "icon": "building",
            },
            {
                "key": "publico",
                "title": {"es": "Instituciones públicas", "ca": "Institucions públiques", "en": "Public institutions"},
                "description": {
                    "es": "Cumplimiento, auditoría y memoria institucional de cada sesión.",
                    "ca": "Compliment, auditoria i memòria institucional de cada sessió.",
                    "en": "Compliance, audit and institutional memory for every session.",
                },
                "icon": "shield",
            },
        ],
        "use_cases_title": {
            ...
            "ca": "Casos d'ús populars",
            "en": "Popular use cases",
        },
        "use_cases": [
            {
                "title": {"es": "Reuniones de proyecto", "ca": "Reunions de projecte", "en": "Project meetings"},
                "description": {"es": "Alineación, decisiones y entregables.", "ca": "Alineació, decisions i lliuraments.", "en": "Alignment, decisions and deliverables."},
            },
            {
                "title": {"es": "Comités ejecutivos", "ca": "Comitès executius", "en": "Executive committees"},
                "description": {"es": "Memoria institucional y trazabilidad.", "ca": "Memòria institucional i traçabilitat.", "en": "Institutional memory and traceability."},
            },
            {
                "title": {"es": "Ventas y cliente", "ca": "Vendes i client", "en": "Sales and customer"},
                "description": {"es": "Followup automático tras cada llamada.", "ca": "Seguiment automàtic després de cada trucada.", "en": "Automatic follow-up after every call."},
            },
            {
                "title": {"es": "Recursos humanos", "ca": "Recursos humans", "en": "Human resources"},
                "description": {"es": "Procesos de selección y feedback estructurado.", "ca": "Processos de selecció i feedback estructurat.", "en": "Hiring processes and structured feedback."},
            },
            {
                "title": {"es": "Producto / Discovery", "ca": "Producte / Discovery", "en": "Product / Discovery"},
                "description": {"es": "Captura de insights y prioridades.", "ca": "Captura d'insights i prioritats.", "en": "Capture of insights and priorities."},
            },
            {
                "title": {"es": "Atención al cliente", "ca": "Atenció al client", "en": "Customer support"},
                "description": {"es": "Casos resueltos con contexto completo.", "ca": "Casos resolts amb context complet.", "en": "Cases solved with full context."},
            },
        ],
        "industries_title": {
            "es": "Soluciones para cada industria",
            "ca": "Solucions per a cada indústria",
            "en": "Solutions for every industry",
        },
        "industries": [
            {"key": "tech",   "title": {"es": "Tecnología",  "ca": "Tecnologia",  "en": "Technology"},     "icon": "code"},
            {"key": "fin",    "title": {"es": "Finanzas",    "ca": "Finances",    "en": "Finance"},        "icon": "chart"},
            {"key": "health", "title": {"es": "Salud",       "ca": "Salut",       "en": "Healthcare"},     "icon": "health"},
            {"key": "edu",    "title": {"es": "Educación",   "ca": "Educació",    "en": "Education"},      "icon": "book"},
            {"key": "manu",   "title": {"es": "Manufactura", "ca": "Manufactura", "en": "Manufacturing"},  "icon": "factory"},
            {"key": "public", "title": {"es": "Sector público","ca": "Sector públic","en": "Public sector"},"icon": "gov"},
        ],
    },

    # ─── /empresa  ─── (case studies grid) ───────────────────────────────
    "case_studies": {
        "eyebrow": {"es": "Empresas", "ca": "Empreses", "en": "Companies"},
        "title": {
            "es": "Historias reales que confían en Acten.",
            "ca": "Històries reals que confien en Acten.",
            "en": "Real stories that trust Acten.",
        },
        "subtitle": {"es": "", "ca": "", "en": ""},
        "items": [
            {
                ...
                "company": "TechNova",
                "logo_url": "",
                "tagline": {"es": "Reuniones de proyecto", "ca": "Reunions de projecte", "en": "Project meetings"},
                "summary": {
                    "es": "MTPs nuevas llegaban sin seguimiento. Ahora cada acción se ejecuta.",
                    "ca": "Les MTPs noves arribaven sense seguiment. Ara cada acció s'executa.",
                    "en": "New MTPs used to arrive without follow-up. Now every action ships.",
                },
                "kpis": [
                    {"label": {"es": "Usuarios activos",      "ca": "Usuaris actius",         "en": "Active users"},        "value": "10K+"},
                    {"label": {"es": "Reuniones procesadas",  "ca": "Reunions processades",   "en": "Meetings processed"},  "value": "2.5M+"},
                    {"label": {"es": "Satisfacción",          "ca": "Satisfacció",            "en": "Satisfaction"},        "value": "98%"},
                    {"label": {"es": "Países",                "ca": "Països",                 "en": "Countries"},           "value": "120+"},
                ],
                "sectors_served": [
                    {"es": "Comités ejecutivos", "ca": "Comitès executius", "en": "Executive committees"},
                    {"es": "Ventas y cliente",   "ca": "Vendes i client",   "en": "Sales and customer"},
                    {"es": "Recursos humanos",   "ca": "Recursos humans",   "en": "Human resources"},
                    {"es": "Educación",          "ca": "Educació",          "en": "Education"},
                ],
            },
            {
                "slug": "buildfast",
                "company": "BuildFast",
                "logo_url": "",
                "tagline": {"es": "Toma de decisiones", "ca": "Presa de decisions", "en": "Decision making"},
                "summary": {
                    "es": "Reuniones de equipo con seguimiento real y trazabilidad ejecutiva.",
                    "ca": "Reunions d'equip amb seguiment real i traçabilitat executiva.",
                    "en": "Team meetings with real follow-up and executive traceability.",
                },
                "kpis": [],
                "sectors_served": [],
            },
            {
                ...
                "company": "DataCore",
                "logo_url": "",
                "tagline": {"es": "Atención al cliente", "ca": "Atenció al client", "en": "Customer support"},
                "summary": {
                    "es": "Calls comerciales que terminan con followup automático en CRM.",
                    "ca": "Trucades comercials que acaben amb seguiment automàtic al CRM.",
                    "en": "Sales calls that end with automatic CRM follow-up.",
                },
                "kpis": [],
                "sectors_served": [],
            },
    ...
    "case_study_detail": {
        "eyebrow": {"es": "Caso de uso", "ca": "Cas d'ús", "en": "Use case"},
        # Plantilla genérica — el componente popula con el caso real
        # buscando por slug en case_studies.items. Estos campos son los
        # labels editables.
        "challenge_label": {"es": "El desafío", "ca": "El repte", "en": "The challenge"},
        "solution_label":  {"es": "Con Acten", "ca": "Amb Acten", "en": "With Acten"},
        "results_label":   {"es": "Resultados", "ca": "Resultats", "en": "Results"},
        "other_cases_label": {"es": "Otros casos de uso", "ca": "Altres casos d'ús", "en": "Other use cases"},
    },

    # ─── /demo ──────────────────────────────────────────────────────────
    "demo_page": {
        "eyebrow": {
            "es": "Solicita una demo personalizada",
            "ca": "Demana una demo personalitzada",
            "en": "Request a personalized demo",
        },
        "title": {
            "es": "Descubre cómo Acten puede transformar la productividad de tu equipo.",
            "ca": "Descobreix com Acten pot transformar la productivitat del teu equip.",
            "en": "Discover how Acten can transform your team's productivity.",
        },
        "subtitle": {"es": "", "ca": "", "en": ""},
        "bullets": [
            {"es": "Cómo funciona Acten en tiempo real", "ca": "Com funciona Acten en temps real", "en": "How Acten works in real time"},
            {"es": "Cómo se adapta a tu operación", "ca": "Com s'adapta a la teva operació", "en": "How it adapts to your operation"},
            {"es": "Cómo lo integramos con tus herramientas", "ca": "Com l'integrem amb les teves eines", "en": "How we integrate it with your tools"},
            {"es": "Plan de implementación recomendado", "ca": "Pla d'implementació recomanat", "en": "Recommended implementation plan"},
        ],
        "form_name_label": {"es": "Nombre completo", "ca": "Nom complet", "en": "Full name"},
        "form_email_label": {"es": "Correo corporativo", "ca": "Correu corporatiu", "en": "Business email"},
        "form_company_label": {"es": "Empresa", "ca": "Empresa", "en": "Company"},
        "form_role_label": {"es": "Cargo", "ca": "Càrrec", "en": "Role"},
        "form_team_size_label": {"es": "Tamaño del equipo", "ca": "Mida de l'equip", "en": "Team size"},
        "form_team_size_options": ["1-10", "11-50", "51-200", "201-1000", "1000+"],
        "form_use_case_label": {"es": "¿Cuál es tu caso de uso principal?", "ca": "Quin és el teu cas d'ús principal?", "en": "What is your main use case?"},
        "form_message_label": {"es": "Mensaje (opcional)", "ca": "Missatge (opcional)", "en": "Message (optional)"},
        "form_cta_label": {"es": "Solicitar demo", "ca": "Demana demo", "en": "Request a demo"},
        "form_success": {
            "es": "¡Recibimos tu solicitud! Te contactamos en menos de 24h hábiles.",
            "ca": "Hem rebut la teva sol·licitud! Et contactem en menys de 24h hàbils.",
            "en": "We got your request! We'll be in touch within 24 business hours.",
        },
        "form_error": {
            "es": "No pudimos enviar tu mensaje. Escríbenos directo a hola@acten.app.",
            "ca": "No hem pogut enviar el teu missatge. Escriu-nos directament a hola@acten.app.",
    ...
    "contact_page": {
        "eyebrow": {"es": "Hablemos", "ca": "Parlem", "en": "Let's talk"},
        "title": {
            "es": "¿Tienes preguntas o quieres saber más?",
            "ca": "Tens preguntes o vols saber-ne més?",
            "en": "Have questions or want to know more?",
        },
        "subtitle": {
        ...
        "channels": [
            {"label": {"es": "Ventas",   "ca": "Vendes",  "en": "Sales"},     "value": "ventas@acten.app",  "icon": "mail"},
            {"label": {"es": "Soporte",  "ca": "Suport",  "en": "Support"},   "value": "soporte@acten.app", "icon": "support"},
            {"label": {"es": "WhatsApp", "ca": "WhatsApp","en": "WhatsApp"},  "value": "+1 (555) 123-4567", "icon": "whatsapp"},
        ],
        "offices_title": {"es": "Oficinas", "ca": "Oficines", "en": "Offices"},
        "offices": [
            {"city": {"es": "Madrid, España",         "ca": "Madrid, Espanya",         "en": "Madrid, Spain"},   "address": "Calle de Serrano 123"},
            {"city": {"es": "Barcelona, España",      "ca": "Barcelona, Espanya",      "en": "Barcelona, Spain"},"address": "Avenida Diagonal 456"},
            {"city": {"es": "Ciudad de México, México","ca": "Ciutat de Mèxic, Mèxic", "en": "Mexico City, Mexico"}, "address": "Av. Reforma 789"},
        ],
        "form_name_label": {"es": "Nombre completo", "ca": "Nom complet", "en": "Full name"},
        "form_email_label": {"es": "Correo electrónico", "ca": "Correu electrònic", "en": "Email"},
        "form_company_label": {"es": "Empresa", "ca": "Empresa", "en": "Company"},
        "form_message_label": {"es": "Mensaje", "ca": "Missatge", "en": "Message"},
        "form_cta_label": {"es": "Enviar mensaje", "ca": "Enviar missatge", "en": "Send message"},
        "form_success": {
            "es": "¡Mensaje enviado! Te respondemos pronto.",
            "ca": "Missatge enviat! Et responem aviat.",
            "en": "Message sent! We'll reply soon.",
        },
        "form_error": {
            "es": "No pudimos enviar tu mensaje. Intenta de nuevo o escríbenos a hola@acten.app.",
            "ca": "No hem pogut enviar el teu missatge. Torna-ho a provar o escriu-nos a hola@acten.app.",
            "en": "We couldn't send your message. Try again or write us at hola@acten.app.",
        },
        "privacy_label": {
            "es": "Acepto la Política de Privacidad",
            "ca": "Accepto la Política de Privadesa",
